...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:for-each select=".//research-resource:research-resource-summary">
    ...
    <xsl:value-of select="normalize-space(translate(.//common:title,'[¬]',''))"/><xsl:text>¬</xsl:text>
    <xsl:value-of select="normalize-space(translate(.//research-resource:hosts/common:organization/common:name,'[¬]',''))"/><xsl:text>¬</xsl:text>
    <xsl:value-of select=".//research-resource:hosts/common:organization/common:address/common:city"/><xsl:text>¬</xsl:text>
    <xsl:value-of select=".//research-resource:hosts/common:organization/common:address/common:region"/><xsl:text>¬</xsl:text>
    <xsl:value-of select=".//research-resource:hosts/common:organization/common:address/common:country"/><xsl:text>¬</xsl:text>
    <xsl:value-of select=".//research-resource:hosts/common:organization/common:disambiguated-organization/common:disambiguated-organization-identifier"/><xsl:text>¬</xsl:text>
    <xsl:value-of select=".//research-resource:hosts/common:organization/common:disambiguated-organization/common:disambiguation-source"/><xsl:text>¬</xsl:text>
