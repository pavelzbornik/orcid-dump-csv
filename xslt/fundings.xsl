...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:for-each select=".//funding:funding-summary">
    ...
    <xsl:value-of select="normalize-space(translate(funding:title/common:title,'[¬]',''))" /><xsl:text>¬</xsl:text>
    ...
    <xsl:value-of select="funding:type"/><xsl:text>¬</xsl:text>
